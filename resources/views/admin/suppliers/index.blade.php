                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Danh sách nhà cung cấp</a></li>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a class="btn btn-info"
                                                    href="{{ route('admin.suppliers.show', $item->id) }}">Xem</a>
                                                <a class="btn btn-warning ms-2"
                                                    href="{{ route('admin.suppliers.edit', $item->id) }}">Sửa</a>
