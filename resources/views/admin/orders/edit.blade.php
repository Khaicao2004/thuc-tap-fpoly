                            ...
                            <form action="{{ route('admin.orders.update', $data) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6 col-12">
                                        <select name="status_payment" id="" class="form-control">
                                            @foreach ($status_payment as $item)
                                                <option value="{{ $item }}"
                                                    @if ($data->status_payment == $item) selected @endif>
                                                    {{ $item }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3 col-12 d-flex justify-content-center">
                                        <button class="btn btn-primary" style="width: 900px" type="submit">Lưu</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ url('admin/users/' . $data->user_id) }}" class="link-secondary">View Profile</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
