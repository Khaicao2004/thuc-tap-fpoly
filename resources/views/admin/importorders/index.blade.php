                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-auto">
                                <div class="d-flex flex-wrap align-items-start gap-2">
                                    <a href="{{ route('admin.importorders.create') }}" type="button"
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a class="btn btn-info"
                                                    href="{{ route('admin.importorders.show', $item->id) }}">Xem</a>
                                                <a class="btn btn-warning ms-2"
                                                    href="{{ route('admin.importorders.edit', $item->id) }}">Sửa</a>
                                                <form action="{{ route('admin.importorders.destroy', $item->id) }}"
