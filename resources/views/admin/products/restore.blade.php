                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle mb-0">
                                            ...
                                            <thead class="table-light">
                                                <form action="{{ route('admin.restore.products') }}" method="POST">
                                                    @csrf
                                                    <table id="example"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex justify-content-between mb-3"
                                                                            style="width: 130px">
                                                                            <p>Is Active</p>
                                                                            {!! $product->is_active ? '<span class="badge bg-primary">YES</span>' : '<span class="badge bg-danger">No</span>' !!}
                                                                        </div>
                                                                        <div class="d-flex justify-content-between mb-3"
                                                                            style="width: 130px">
                                                                            <p>Is Hot Deal</p>
                                                                            {!! $product->is_hot_deal ? '<span class="badge bg-primary">YES</span>' : '<span class="badge bg-danger">No</span>' !!}
                                                                        </div>
                                                                        <div class="d-flex justify-content-between mb-3"
                                                                            style="width: 130px">
                                                                            <p>Is Good Deal</p>
                                                                        ...
                                                                        <div class="d-flex justify-content-between mb-3"
                                                                            style="width: 130px">
                                                                            <p>Is New</p>
                                                                            {!! $product->is_new ? '<span class="badge bg-primary">YES</span>' : '<span class="badge bg-danger">No</span>' !!}
                                                                        </div>
                                                                        <div class="d-flex justify-content-between mb-3"
                                                                            style="width: 130px">
                                                                            <p>Is Show Home</p>
