       ...
       <section class="product spad">
        <div class="container">
            ...
            <div class="row product__filter">
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="/theme/client/img/product/product-1.jpg">
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="#"><img src="/theme/client/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="/theme/client/img/product/product-5.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="/theme/client/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="/theme/client/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="/theme/client/img/icon/search.png" alt=""></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="/theme/client/img/product/product-6.jpg">
                            <span class="label">Sale</span>
                            <ul class="product__hover">
                                <li><a href="#"><img src="/theme/client/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="/theme/client/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="/theme/client/img/product/product-7.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="/theme/client/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="/theme/client/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="/theme/client/img/icon/search.png" alt=""></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix hot-sales">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="/theme/client/img/product/product-8.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="/theme/client/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="/theme/client/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="/theme/client/img/icon/search.png" alt=""></a></li>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="instagram__pic">
                        <div class="instagram__pic__item set-bg" data-setbg="/theme/client/img/instagram/instagram-1.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="/theme/client/img/instagram/instagram-2.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="/theme/client/img/instagram/instagram-3.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="/theme/client/img/instagram/instagram-4.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="/theme/client/img/instagram/instagram-5.jpg"></div>
                        <div class="instagram__pic__item set-bg" data-setbg="/theme/client/img/instagram/instagram-6.jpg"></div>
                    </div>
                </div>
                <div class="col-lg-4">
